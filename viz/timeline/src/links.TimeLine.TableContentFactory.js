(function(type){
	...
	links.Timeline.TableContentFactory.prototype.get = function(data) {
			...
			$("<div>",{css:{"display":"block"}}).append(
				[ data.imgB64 ?
					$(
						"<div>",
						{
							css:{"font-size":"10px",position:"relative",top:"0px","left":"0px"}
						}
					).append(
						$(
							"<div>",
							{
								css:{"border-style":"outset","border-width":"1px","float":"left",position:"relative"},
		...
		$table.find("div.timeline-event-detail").css({"border-color":borderColor});
